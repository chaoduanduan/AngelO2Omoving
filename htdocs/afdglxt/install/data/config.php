...
define('AvatarCMSConfig',TRUE);
$ecms_config=array();

//数据库设置
$ecms_config['db']['usedb']='<!--dbtype.caity.net-->';	//数据库类型
$ecms_config['db']['dbver']='<!--dbver.caity.net-->';	//数据库版本
$ecms_config['db']['dbserver']='<!--host.caity.net-->';	//数据库登录地址
$ecms_config['db']['dbport']='<!--port.caity.net-->';	//端口，不填为按默认
$ecms_config['db']['dbusername']='<!--username.caity.net-->';	//数据库用户名
$ecms_config['db']['dbpassword']='<!--password.caity.net-->';	//数据库密码
$ecms_config['db']['dbname']='<!--name.caity.net-->';	//数据库名
$ecms_config['db']['setchar']='<!--char.caity.net-->';	//设置默认编码
$ecms_config['db']['dbchar']='<!--dbchar.caity.net-->';	//数据库默认编码
$ecms_config['db']['dbtbpre']='<!--tbpre.caity.net-->';	//数据表前缀
$dbtbpre=$ecms_config['db']['dbtbpre'];	//数据表前缀
$ecms_config['db']['showerror']=1;	//显示SQL错误提示(0为不显示,1为显示)


//页面编码设置
$ecms_config['sets']['pagechar']='<!--headerchar.caity.net-->';	//安装阿凡达CMS的编码版本
...
//-------AvatarCMS.Seting.area-------

//后台安全设置
$ecms_config['esafe']['loginauth']='<!--loginauth.caity.net-->';	//登录认证码,如果设置登录需要输入此认证码才能通过
$ecms_config['esafe']['ecookiernd']='<!--cookiernd.caity.net-->';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='<!--cookiepre.caity.net-->';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='<!--admincookiepre.caity.net-->';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='<!--qcookiernd.caity.net-->';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='<!--qcookierndtwo.caity.net-->';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
//-------AvatarCMS.Public.Cache-------

//------------e_public
$public_r=array('sitename'=>'阿凡达网站管理系统',
