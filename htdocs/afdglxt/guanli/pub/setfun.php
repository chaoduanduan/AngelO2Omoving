...
function ReturnSettingString($r){
	...
	//COOKIE
	$text=str_replace('[!@--caity_cookiedomain--@!]',addslashes($r[caity_cookiedomain]),$text);
	$text=str_replace('[!@--caity_cookiepath--@!]',addslashes($r[caity_cookiepath]),$text);
	$text=str_replace('[!@--caity_cookievarpre--@!]',addslashes($r[caity_cookievarpre]),$text);
	$text=str_replace('[!@--caity_cookieadminvarpre--@!]',addslashes($r[caity_cookieadminvarpre]),$text);
	$text=str_replace('[!@--caity_cookieckrnd--@!]',addslashes($r[caity_cookieckrnd]),$text);
	$text=str_replace('[!@--caity_cookieckrndtwo--@!]',addslashes($r[caity_cookieckrndtwo]),$text);
	//防火墙
...
function GetSettingConfig($string){
	$filename=ECMS_PATH."afdglxt/config/config.php";
	$exp='//-------AvatarCMS.Seting.area-------';
	$text=ReadFiletext($filename);
	$r=explode($exp,$text);
	if($r[0]=='')
	{
...
function SetFirewall($add,$userid,$username){
	...
	$r[caity_cookiedomain]=$ecms_config['cks']['ckdomain'];
	$r[caity_cookiepath]=$ecms_config['cks']['ckpath'];
	$r[caity_cookievarpre]=$ecms_config['cks']['ckvarpre'];
	$r[caity_cookieadminvarpre]=$ecms_config['cks']['ckadminvarpre'];
	$r[caity_cookieckrnd]=$ecms_config['cks']['ckrnd'];
	$r[caity_cookieckrndtwo]=$ecms_config['cks']['ckrndtwo'];
...
function SetSafe($add,$userid,$username){
	...
	$r[caity_cookiedomain]=$add[cookiedomain];
	$r[caity_cookiepath]=$add[cookiepath];
	$r[caity_cookievarpre]=$add[cookievarpre];
	$r[caity_cookieadminvarpre]=$add[cookieadminvarpre];
	$r[caity_cookieckrnd]=$add[cookieckrnd];
	$r[caity_cookieckrndtwo]=$add[cookieckrndtwo];
	//原来设置
	...
	//操作日志
	insert_dolog('');
	if($ecms_config['esafe']['ecookiernd']!=$r[do_ecookiernd]||$ecms_config['cks']['ckadminvarpre']!=$r[caity_cookieadminvarpre]||$ecms_config['esafe']['ckhanytime']!=$r[do_ckhanytime])
	{
