...
while($r=$Avatar->fetch($sql))
{
  ...
  <tr> 
    <td width='96%' rowspan='2'><div align='center'><a href='#Avatarcms' title='点击选择' onclick=\"javascript:".$buttonurl."\"><img src='".$file."' width='".$width."' height='".$height."' border=0></a></div></td>
