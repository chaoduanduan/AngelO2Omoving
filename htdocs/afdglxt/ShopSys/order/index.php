...
if(getcvar('mluserid'))
{
	...
	else
	{
		...
		$useraddr=$Avatar->fetch1("select truename,oicq,msn,`mycall`,phone,address,zip from {$dbtbpre}enewsmemberadd where userid='$user[userid]' limit 1");
	}
}
//导入模板
require(ECMS_PATH.'afdglxt/template/ShopSys/order.php');
db_close();
$Avatar=null;
?>