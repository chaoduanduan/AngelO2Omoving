...
$ttr=$Avatar->fetch1("select typeid,tname,mid,yhid,tnum,listtempid,tpath,ttype,maxnum,reorder,tid,tbname,timg,intro,pagekey,listdt,repagenum from {$dbtbpre}enewsinfotype where typeid='$ttid'");
$tbname=$ttr['tbname'];
...
$pagekey=$ttr['pagekey'];
$pagedes=$ttr['intro'];
$classimg=$ttr['timg']?$ttr['timg']:$public_r[newsurl].'afdglxt/data/images/notimg.gif';
