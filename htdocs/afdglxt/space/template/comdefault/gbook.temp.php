            ...
            <td> 
              <table width="160" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="85"><img src="<?=$public_r[newsurl]?>afdglxt/ShowKey/?v=spacegb" name="spacegbKeyImg" id="spacegbKeyImg" onclick="spacegbKeyImg.src='<?=$public_r[newsurl]?>afdglxt/ShowKey/?v=spacegb&t='+Math.random()" title="看不清楚,点击刷新" /></td>
                </tr>
              </table></td>
        </tr>
        <tr> 
