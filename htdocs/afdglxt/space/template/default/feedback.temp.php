          ...
          <tr>
            ...
            <td><table width="160" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  ...
                  <td width="85"><img src="<?=$public_r[newsurl]?>afdglxt/ShowKey/?v=spacefb" name="spacefbKeyImg" id="spacefbKeyImg" onclick="spacefbKeyImg.src='<?=$public_r[newsurl]?>afdglxt/ShowKey/?v=spacefb&t='+Math.random()" title="看不清楚,点击刷新" /></td>
                </tr>
              </table></td>
          </tr>
          <tr> 
