...
$sql=$Avatar->query("select groupid,groupname from {$dbtbpre}enewsmembergroup where canreg=1 order by level,groupid");
//导入模板
require(ECMS_PATH.'afdglxt/template/member/ChangeRegister.php');
db_close();
$Avatar=null;
?>