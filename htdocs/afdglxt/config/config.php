...
$ecms_config['db']['dbserver']='qdm16412339.my3w.com';	//数据库登录地址
$ecms_config['db']['dbport']='';	//端口，不填为按默认
$ecms_config['db']['dbusername']='qdm16412339';	//数据库用户名
$ecms_config['db']['dbpassword']='12345678';	//数据库密码
$ecms_config['db']['dbname']='qdm16412339_db';	//数据库名
$ecms_config['db']['setchar']='utf8';	//设置默认编码
$ecms_config['db']['dbchar']='utf8';	//数据库默认编码
$ecms_config['db']['dbtbpre']='caity_';	//数据表前缀
$dbtbpre=$ecms_config['db']['dbtbpre'];	//数据表前缀
$ecms_config['db']['showerror']=1;	//显示SQL错误提示(0为不显示,1为显示)


//页面编码设置
$ecms_config['sets']['pagechar']='utf-8';	//安装阿凡达CMS的编码版本
...
$ecms_config['esafe']['ecookiernd']='ehypaPmkIcOCwVd8tQ7gYBOTtQuEyj';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='unggm';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='pferr';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='VGIN1pSPQhXYAM0mdNNJ87dzBsBcWm';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='kNuJSrGCAijmBqg6h089q7JRozllNc';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
//------------e_public
$public_r=array('sitename'=>'Angel Tech',
'newsurl'=>'http://www.angleo2omoving.com/',
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'0kbkubeirVBIXuSKyv4qstT0Mr44uw',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"http://www.angleo2omoving.com/wzgk/\">网站概况</a>&nbsp;|&nbsp;<a href=\"http://www.angleo2omoving.com/xwzx/\">新闻中心</a>&nbsp;|&nbsp;<a href=\"http://www.angleo2omoving.com/clmm/\">车辆服务</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
