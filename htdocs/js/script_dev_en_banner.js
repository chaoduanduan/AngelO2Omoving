...
(function (a) {
	a.fn.extend({
		"soChange":function (b) {
			b=a.extend({
				thumbObj:null,botPrev:null,botNext:null,changeType:'fade',thumbNowClass:'now',thumbOverEvent:true,slideTime:2000,autoChange:true,clickFalse:true,overStop:true,changeTime:6000,delayTime:300
			},b||{
			});
			var c=a(this);
			var d;
