...
while($r=$Avatar->fetch($sql))
{
	...
	$infor=$Avatar->fetch1("select id,classid,titlepic,newstime,isurl,titleurl,".$titlefield.",".$smalltextfield." from {$dbtbpre}ecms_".$tbname." where id='$r[id]' limit 1");
	if(empty($infor['id']))
	{
		continue;
	}
...
<form action="/afdglxt/search/index.php" method="post" name="searchform" id="searchform">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="4" class="copyright">
        <tr> 
          <td align="center"><a href="/">网站首页</a> | <a href="#">关于我们</a> 
            ...
            | <a href="#">网站地图</a> | <a href="#">免责声明</a> | <a href="/afdglxt/wap/" target="_blank">WAP</a></td>
        </tr>
        <tr> 
          <td align="center">Powered by <strong><a href="http://www.caity.net" target="_blank">AvatarCMS</a></strong> 
            <strong><font color="#FF9900">7.2</font></strong>&nbsp; &copy; 2002-2015 
            <a href="http://www.digod.com" target="_blank">AvatarSoft Inc.</a></td>
        </tr>
	</table>
</td>
</tr>
