...
//菜单显示
$showfastmenu=$Avatar->gettotal("select count(*) as total from {$dbtbpre}enewsmenuclass where classtype=1 limit 1");//常用菜单
$showextmenu=$Avatar->gettotal("select count(*) as total from {$dbtbpre}enewsmenuclass where classtype=3 limit 1");//扩展菜单
...
<td height="60">
  ...
  <form name="menuform" id="menuform">
	...
	<input type="hidden" name="onclickmenu" value="">
      <TR> 
            <TD width="180"><div align="center"><a href="main.php<?=$ecms_hashur['whehref']?>" target="main" title="阿凡达网站管理系统"><img src="adminstyle/1/images/logo.gif" border="0"></a></div></TD>
		<TD height="60"> 
