...
$user_r=$Avatar->fetch1("select adminclass,groupid from {$dbtbpre}enewsuser where userid='$logininid'");
//用户组权限
...
function ShRM(obj,bclassid,classid,classurl,showmenu)
{
  ...
  classurl='<?=$public_r[newsurl]?>afdglxt/public/ClassUrl/?classid='+classid;
if(showmenu==1)
{
  popupoptions = [
