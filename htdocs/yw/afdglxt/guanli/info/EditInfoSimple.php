...
//-----------------------------------------修改信息
//索引表
$index_r=$Avatar->fetch1("select classid,id,checked from {$dbtbpre}ecms_".$class_r[$classid][tbname]."_index where id='$id' limit 1");
...
//副表
$finfor=$Avatar->fetch1("select closepl from ".$infodatatb." where id='$id'");
