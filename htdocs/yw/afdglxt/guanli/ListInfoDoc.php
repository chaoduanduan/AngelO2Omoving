...
{
	$thisclassr=$Avatar->fetch1("select listorder from {$dbtbpre}enewsclass where classid='$classid'");
...
//导入页面
$deftempfile=ECMS_PATH.'afdglxt/data/html/list/doclistinfo.php';
if($infomod_r[listfile])
{
	$tempfile=ECMS_PATH.'afdglxt/data/html/list/doc'.$infomod_r[listfile].'.php';
