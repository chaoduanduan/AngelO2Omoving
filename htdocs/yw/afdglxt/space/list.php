...
$mr=$Avatar->fetch1("select tbname,qmname,sonclass from {$dbtbpre}enewsmod where mid='$mid'");
...
{
	$modnum=$Avatar->gettotal("select count(*) as total from {$dbtbpre}enewsmod where tbname='$mr[tbname]'");
	if($modnum>1)
	{
