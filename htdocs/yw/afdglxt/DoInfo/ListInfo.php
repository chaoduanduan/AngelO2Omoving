...
$mr=$Avatar->fetch1("select tbname,qmname,listfile,sonclass from {$dbtbpre}enewsmod where mid='$mid'");
...
//导入页面
$deftempfile=ECMS_PATH.'afdglxt/data/html/list/qlistinfo.php';
if($mr[listfile])
{
	$tempfile=ECMS_PATH.'afdglxt/data/html/list/q'.$mr[listfile].'.php';
