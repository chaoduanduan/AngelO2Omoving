...
$payr=$Avatar->fetch1("select * from {$dbtbpre}enewspayapi where payid='$payid' and isclose=0");
if(!$payr[payid])
{
	printerror('请选择支付平台','',1,0,1);
}
...
if($caity=='PayToFen'||$caity=='PayToMoney')
{
	$user=islogin();//是否登陆
