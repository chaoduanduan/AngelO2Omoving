...
//操作事件
$caity=getcvar('paycaity');
if($caity=='PayToFen')//购买点数
{}
elseif($caity=='PayToMoney')//存预付款
{}
elseif($caity=='ShopPay')//商城支付
{}
elseif($caity=='BuyGroupPay')//购买充值类型
{}
else
{
...
$user=array();
if($caity=='PayToFen'||$caity=='PayToMoney'||$caity=='BuyGroupPay')
{
	$user=islogin();//是否登陆
}

$paytype='tenpay';
$payr=$Avatar->fetch1("select * from {$dbtbpre}enewspayapi where paytype='$paytype' limit 1");
