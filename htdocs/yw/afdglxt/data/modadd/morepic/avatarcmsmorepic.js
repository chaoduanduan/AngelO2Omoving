...
function yecmsShowSmallPics(){
	...
	for(i=0;i<ecmspicnum;i++)
	{
		...
		str+='<td bgcolor="#cccccc" align="center" id="espicid'+i+'"'+cname+'><a href="#Avatarcms" onclick="ecmsShowPic('+i+');"><img src="'+ecmspicr[i][0]+'" width="'+epicswidth+'" height="'+epicsheight+'" border="0"></a><br>'+(i+1)+'/'+ecmspicnum+'</td>';
