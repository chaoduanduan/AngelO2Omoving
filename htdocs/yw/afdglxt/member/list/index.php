...
if($sear)
{
	...
	if($formid)
	{
		...
		$search.='&andor='.$andor;
		$formr=$Avatar->fetch1("select searchvar from {$dbtbpre}enewsmemberform where fid='$formid'");
...
$tempfile=ECMS_PATH.'afdglxt/template/member/memberlist/'.$tempid.'.php';
if(!file_exists($tempfile))
{
	$tempfile=ECMS_PATH.'afdglxt/template/member/memberlist/1.php';
}
