...
DoSetDbChar('utf8');
E_D("DROP TABLE IF EXISTS `xcaity_enewspostserver`;");
E_C("CREATE TABLE `xcaity_enewspostserver` (
...
E_D("replace into `xcaity_enewspostserver` values('1','附件服务器','','1','','','','','','0','0','0','0','0');");
