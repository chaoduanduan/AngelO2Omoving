...
DoSetDbChar('utf8');
E_D("DROP TABLE IF EXISTS `xcaity_enewsclass_stats_set`;");
E_C("CREATE TABLE `xcaity_enewsclass_stats_set` (
...
E_D("replace into `xcaity_enewsclass_stats_set` values('1','3600','0','20130717');");
