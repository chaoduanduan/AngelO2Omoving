...
DoSetDbChar('utf8');
E_D("DROP TABLE IF EXISTS `xcaity_enewspublic_update`;");
E_C("CREATE TABLE `xcaity_enewspublic_update` (
...
E_D("replace into `xcaity_enewspublic_update` values('1','1355124469','1355124476','15','0','|1,15|','','1432272425','1432272425','6','9','0','0');");
