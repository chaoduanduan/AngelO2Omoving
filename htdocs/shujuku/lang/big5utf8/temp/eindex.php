...
<table width="100%" border="0" cellspacing="8" cellpadding="3">
  <tr>
      <td><div align="center"><a href="http://#" target="_blank"><img src="images/logo.jpg" alt="Empire Soft" width="180" height="65" border="0"></a></div></td>
    </tr>
    <tr>
      <td><div align="center"><strong><font size="5">歡迎使用&nbsp;EmpireBak&nbsp;v2010</font></strong></div></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><table width="420" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#0472BC">
        <form name="form1" method="post" action="phome.php">
          ...
          <tr> 
            <td height="25" colspan="2"><div align="center"><strong><font color="#FFFFFF">管理員登錄</font></strong></div></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
